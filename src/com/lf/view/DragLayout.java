...
public class DragLayout extends FrameLayout {
	...
	protected void onFinishInflate() {
		...
		if (isShowShadow) {
			...
			iv_shadow
					.setBackgroundColor(getResources().getColor(R.color.bg_no));
			// iv_shadow.setImageResource(R.drawable.bg_food);
	 ...
	 * @param range
	 */
	public void setLeftRange(int range) {
		this.range = range;
	}
